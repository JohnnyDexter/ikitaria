(function () {
  ...
  var btLabel =
    { it: "Torna in cima", en: "Back to top", ja: "トップへ戻る" }[lang] ||
    "Back to top";
  ...
  if (!localStorage.getItem("ikitaria_cookie_consent")) {
    ...
    var cbTexts = {
      it: {
        text:
          'Utilizziamo cookie per migliorare la tua esperienza di navigazione. Consulta la nostra <a href="' +
          privacyLink +
          '">Privacy Policy</a>.',
        accept: "Accetto",
      ...
      en: {
        text:
          'We use cookies to improve your browsing experience. See our <a href="' +
          privacyLink +
          '">Privacy Policy</a>.',
        accept: "Accept",
      ...
      ja: {
        text:
          'より良い体験のためCookieを使用しています。詳しくは<a href="' +
          privacyLink +
          '">プライバシーポリシー</a>をご覧ください。',
        accept: "同意する",
        decline: "必須のみ",
      },
    };
    ...
    banner.innerHTML =
      ...
      '<button class="cookie-btn-accept" id="cb-accept">' +
      t.accept +
      "</button>" +
      '<button class="cookie-btn-decline" id="cb-decline">' +
      t.decline +
      "</button>" +
      "</div>" +
      "</div>";
  ...
  [".three-columns", ".two-columns", ".stats-grid", ".why-list"].forEach(
    function (gridSel) {
  ...
  // ── Business tabs ──────────────────────────────────────────
  var tabBtns = document.querySelectorAll(".biz-tab-btn");
  if (tabBtns.length) {
    tabBtns.forEach(function (btn) {
      btn.addEventListener("click", function () {
        ...
        document.querySelectorAll(".biz-tab-panel").forEach(function (p) {
